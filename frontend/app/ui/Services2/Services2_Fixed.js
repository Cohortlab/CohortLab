    ...
    <div className="space-y-16 px-4 max-w-7xl mx-auto">
      ...
      <section>
        ...
        <ul className="grid grid-cols-1 gap-4 md:grid-cols-12 md:grid-rows-3 lg:gap-6">
          <GridItem
            ...
            icon={<Box className="h-5 w-5 text-neutral-400" />}
          ...
          <GridItem
            ...
            icon={<Smartphone className="h-5 w-5 text-neutral-400" />}
      ...
      <section>
        ...
        <ul className="grid grid-cols-1 gap-4 md:grid-cols-12 md:grid-rows-2 lg:gap-6">
          <GridItem
            area="md:[grid-area:1/1/2/7]"
            icon={<Cpu className="h-5 w-5 text-neutral-400" />}
          ...
          <GridItem
            area="md:[grid-area:2/1/3/13]"
            icon={<Cloud className="h-5 w-5 text-neutral-400" />}
      ...
      <section>
        ...
        <ul className="grid grid-cols-1 gap-4 md:grid-cols-12 md:grid-rows-1 lg:gap-6">
          ...
          <GridItem
            ...
            icon={<LifeBuoy className="h-5 w-5 text-neutral-400" />}
  ...
  return (
    <li className={`min-h-[14rem] list-none ${area}`}>
      <div className="relative h-full rounded-2xl border p-2 md:rounded-3xl md:p-3">
        ...
        <div className="relative flex h-full flex-col justify-between gap-6 overflow-hidden rounded-xl p-6 shadow-[0px_0px_27px_0px_#2D2D2D]">
          <div className="relative flex flex-1 flex-col justify-between gap-3">
            ...
            <div className="space-y-3">
              ...
              <h2 className="font-sans text-sm text-neutral-400 md:text-base [&_b]:md:font-semibold [&_strong]:md:font-semibold">
                {description}
              </h2>
            </div>
          </div>
