    ...
    <LampContainer>
      <div className="relative z-10 mx-auto max-w-7xl py-16 mt-70">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            ...
            <div className="group m-0 border border-gray-700 flex flex-col items-start max-w-sm p-6 relative h-[28rem] rounded-2xl shadow-lg bg-gray-800/80 transition-transform duration-200 hover:scale-105 hover:shadow-2xl">
              <Icon className="absolute h-6 w-6 -top-3 -left-3 text-blue-300" />
              <Icon className="absolute h-6 w-6 -bottom-3 -left-3 text-purple-300" />
              <Icon className="absolute h-6 w-6 -top-3 -right-3 text-blue-300" />
              <Icon className="absolute h-6 w-6 -bottom-3 -right-3 text-purple-300" />
              <EvervaultCard text="Website Design &amp; Development" />
              <h2 className="text-white mt-4 text-base font-semibold">We create modern, responsive, and high-performing websites tailored to your business goals.</h2>
            </div>
            <div className="group m-0 border border-gray-700 flex flex-col items-start max-w-sm p-6 relative h-[28rem] rounded-2xl shadow-lg bg-gray-800/80 transition-transform duration-200 hover:scale-105 hover:shadow-2xl">
              <Icon className="absolute h-6 w-6 -top-3 -left-3 text-blue-300" />
              <Icon className="absolute h-6 w-6 -bottom-3 -left-3 text-purple-300" />
              ...
              <h2 className="text-white mt-4 text-base font-semibold">Expand globally by making your website available in multiple languages with cultural accuracy.</h2>
            </div>
            <div className="group m-0 border border-gray-700 flex flex-col items-start max-w-sm p-6 relative h-[28rem] rounded-2xl shadow-lg bg-gray-800/80 transition-transform duration-200 hover:scale-105 hover:shadow-2xl">
              <Icon className="absolute h-6 w-6 -top-3 -left-3 text-blue-300" />
              <Icon className="absolute h-6 w-6 -bottom-3 -left-3 text-purple-300" />
              ...
              <h2 className="text-white mt-4 text-base font-semibold">Clean, user-focused designs that enhance usability and keep visitors engaged.</h2>
            </div>
            <div className="group m-0 border border-gray-700 flex flex-col items-start max-w-sm p-6 relative h-[28rem] rounded-2xl shadow-lg bg-gray-800/80 transition-transform duration-200 hover:scale-105 hover:shadow-2xl">
              <Icon className="absolute h-6 w-6 -top-3 -left-3 text-blue-300" />
              ...
              <h2 className="text-white mt-4 text-base font-semibold">Scalable dashboards, portals, and SaaS applications built to solve your business needs.</h2>
            </div>
            <div className="group m-0 border border-gray-700 flex flex-col items-start max-w-sm p-6 relative h-[28rem] rounded-2xl shadow-lg bg-gray-800/80 transition-transform duration-200 hover:scale-105 hover:shadow-2xl">
              <Icon className="absolute h-6 w-6 -top-3 -left-3 text-blue-300" />
              <Icon className="absolute h-6 w-6 -bottom-3 -left-3 textPurple-400 dark:text-purple-300" />
              ...
              <h2 className="text-white mt-4 text-base font-semibold">Easy-to-manage websites powered by WordPress, Webflow, or modern headless CMS platforms.</h2>
            </div>
            <div className="group m-0 border border-gray-700 flex flex-col items-start max-w-sm p-6 relative h-[28rem] rounded-2xl shadow-lg bg-gray-800/80 transition-transform duration-200 hover:scale-105 hover:shadow-2xl">
              <Icon className="absolute h-6 w-6 -top-3 -left-3 text-blue-300" />
              <Icon className="absolute h-6 w-6 -bottom-3 -left-3 textPurple-400 dark:text-purple-300" />
              ...
              <h2 className="text-white mt-4 text-base font-semibold">Easy-to-manage cross-platform Mobile Application
            ...
            <div className="group m-0 border border-gray-700 flex flex-col items-start max-w-sm p-6 relative h-[28rem] rounded-2xl shadow-lg bg-gray-800/80 transition-transform duration-200 hover:scale-105 hover:shadow-2xl">
              <Icon className="absolute h-6 w-6 -top-3 -left-3 text-green-300" />
              <Icon className="absolute h-6 w-6 -bottom-3 -left-3 text-blue-300" />
              <Icon className="absolute h-6 w-6 -top-3 -right-3 text-green-300" />
              <Icon className="absolute h-6 w-6 -bottom-3 -right-3 text-blue-300" />
              <EvervaultCard text="SEO (Search Engine Optimization)" />
              <h2 className="text-white mt-4 text-base font-semibold">Optimize your website to rank higher on Google and attract organic traffic.</h2>
            </div>
            <div className="group m-0 border border-gray-700 flex flex-col items-start max-w-sm p-6 relative h-[28rem] rounded-2xl shadow-lg bg-gray-800/80 transition-transform duration-200 hover:scale-105 hover:shadow-2xl">
              <Icon className="absolute h-6 w-6 -top-3 -left-3 text-green-300" />
              <Icon className="absolute h-6 w-6 -bottom-3 -left-3 text-blue-300" />
              ...
              <h2 className="text-white mt-4 text-base font-semibold">Faster websites with improved Core Web Vitals for better user experience and rankings.</h2>
            </div>
            <div className="group m-0 border border-gray-700 flex flex-col items-start max-w-sm p-6 relative h-[28rem] rounded-2xl shadow-lg bg-gray-800/80 transition-transform duration-200 hover:scale-105 hover:shadow-2xl">
              <Icon className="absolute h-6 w-6 -top-3 -left-3 text-green-300" />
              <Icon className="absolute h-6 w-6 -bottom-3 -left-3 text-blue-300" />
              ...
              <h2 className="text-white mt-4 text-base font-semibold">Data-driven insights with tools like Google Analytics to measure and improve results.</h2>
            </div>
            ...
            <div className="group m-0 border border-gray-700 flex flex-col items-start max-w-sm p-6 relative h-[28rem] rounded-2xl shadow-lg bg-gray-800/80 transition-transform duration-200 hover:scale-105 hover:shadow-2xl">
              ...
              <h2 className="text-white mt-4 text-base font-semibold">Build your brand presence with consistent and engaging social media content.</h2>
            </div>
            <div className="group m-0 border border-gray-700 flex flex-col items-start max-w-sm p-6 relative h-[28rem] rounded-2xl shadow-lg bg-gray-800/80 transition-transform duration-200 hover:scale-105 hover:shadow-2xl">
              <Icon className="absolute h-6 w-6 -top-3 -left-3 text-pink-400 dark:text-pink-300" />
              <Icon className="absolute h-6 w-6 -bottom-3 -left-3 text-yellow-400 dark:text-yellow-300" />
              ...
              <h2 className="text-white mt-4 text-base font-semibold">Targeted ad campaigns to reach the right audience and maximize ROI.</h2>
            </div>
            <div className="group m-0 border border-gray-700 flex flex-col items-start max-w-sm p-6 relative h-[28rem] rounded-2xl shadow-lg bg-gray-800/80 transition-transform duration-200 hover:scale-105 hover:shadow-2xl">
              <Icon className="absolute h-6 w-6 -top-3 -left-3 text-pink-400 dark:text-pink-300" />
              <Icon className="absolute h-6 w-6 -bottom-3 -left-3 text-yellow-400 dark:text-yellow-300" />
              ...
              <h2 className="text-white mt-4 text-base font-semibold">Automated and personalized campaigns that nurture leads and retain customers.</h2>
            </div>
            <div className="group m-0 border border-gray-700 flex flex-col items-start max-w-sm p-6 relative h-[28rem] rounded-2xl shadow-lg bg-gray-800/80 transition-transform duration-200 hover:scale-105 hover:shadow-2xl">
              <Icon className="absolute h-6 w-6 -top-3 -left-3 text-pink-400 dark:text-pink-300" />
              <Icon className="absolute h-6 w-6 -bottom-3 -left-3 text-yellow-400 dark:text-yellow-300" />
              ...
              <h2 className="text-white mt-4 text-base font-semibold">Complete branding solutions including logos, colors, and style guides to define your business.</h2>
            </div>
            ...
            <div className="group m-0 border border-gray-700 flex flex-col items-start max-w-sm p-6 relative h-[28rem] rounded-2xl shadow-lg bg-gray-800/80 transition-transform duration-200 hover:scale-105 hover:shadow-2xl">
              ...
              <h2 className="text-white mt-4 text-base font-semibold">Smart chatbots, automation, and AI assistants to improve efficiency and user experience.</h2>
            </div>
            <div className="group m-0 border border-gray-700 flex flex-col items-start max-w-sm p-6 relative h-[28rem] rounded-2xl shadow-lg bg-gray-800/80 transition-transform duration-200 hover:scale-105 hover:shadow-2xl">
              <Icon className="absolute h-6 w-6 -top-3 -left-3 text-indigo-400 dark:text-indigo-300" />
              <Icon className="absolute h-6 w-6 -bottom-3 -left-3 text-fuchsia-400 dark:text-fuchsia-300" />
              ...
              <h2 className="text-white mt-4 text-base font-semibold">Cross Platform apps using React Native for seamless cross-platform experiences.</h2>
            </div>
            <div className="group m-0 border border-gray-700 flex flex-col items-start max-w-sm p-6 relative h-[28rem] rounded-2xl shadow-lg bg-gray-800/80 transition-transform duration-200 hover:scale-105 hover:shadow-2xl">
              <Icon className="absolute h-6 w-6 -top-3 -left-3 text-indigo-400 dark:text-indigo-300" />
              <Icon className="absolute h-6 w-6 -bottom-3 -left-3 text-fuchsia-400 dark:text-fuchsia-300" />
              ...
              <h2 className="text-white mt-4 text-base font-semibold">Scalable, secure hosting with automated deployment and monitoring.</h2>
            </div>
            ...
            <div className="group m-0 border border-gray-700 flex flex-col items-start max-w-sm p-6 relative h-[28rem] rounded-2xl shadow-lg bg-gray-800/80 transition-transform duration-200 hover:scale-105 hover:shadow-2xl">
              ...
              <h2 className="text-white mt-4 text-base font-semibold">Regular updates, backups, and fixes to keep your site running smoothly.</h2>
            </div>
            <div className="group m-0 border border-gray-700 flex flex-col items-start max-w-sm p-6 relative h-[28rem] rounded-2xl shadow-lg bg-gray-800/80 transition-transform duration-200 hover:scale-105 hover:shadow-2xl">
              <Icon className="absolute h-6 w-6 -top-3 -left-3 text-gray-400 dark:text-gray-300" />
              <Icon className="absolute h-6 w-6 -bottom-3 -left-3 text-gray-700 dark:text-gray-500" />
              ...
              <h2 className="text-white mt-4 text-base font-semibold">SSL, GDPR readiness, and penetration testing for complete online safety.</h2>
            </div>
            <div className="group m-0 border border-gray-700 flex flex-col items-start max-w-sm p-6 relative h-[28rem] rounded-2xl shadow-lg bg-gray-800/80 transition-transform duration-200 hover:scale-105 hover:shadow-2xl">
              <Icon className="absolute h-6 w-6 -top-3 -left-3 text-gray-400 dark:text-gray-300" />
              <Icon className="absolute h-6 w-6 -bottom-3 -left-3 text-gray-700 dark:text-gray-500" />
              ...
              <h2 className="text-white mt-4 text-base font-semibold">Always-on support to solve issues whenever you need us.</h2>
            </div>
