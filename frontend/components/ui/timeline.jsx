    ...
    <div
      ...
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        <p
          ...
          I&apos;ve been working on CohortLab for the past 2 years. Here&apos;s
          a way of my thinking.
        </p>
      </div>
        ...
        {data.map((item, index) => (
          <div key={index} className="flex justify-start pt-10 md:pt-40 md:gap-10">
            <div
              ...
              <div
                className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-background dark:bg-background flex items-center justify-center">
                <div
